...
def get_movies(db: Session = Depends(get_db)):
    ...
    if not movies:
        seed_data = [
            ...
            MovieModel(title="Billa", description="A stylish gangster drama starring Ajith Kumar / Prabhas.", rating=8.5, image="https://images.unsplash.com/photo-1535016120720-40c646bebbcf", genre="Action", language="Hindi", category="Latest", quality="1080p WebRip", video_url="https://www.youtube.com/embed/O-L1E8y9eSg", download_url="https://movierulz.cine/dl/billa_hd_dual.mkv"),
            ...
            MovieModel(title="Stree 2", description="The horror-comedy sequel that breaks all records.", rating=8.2, image="https://images.unsplash.com/photo-1509347528160-9a9e33742cdb", genre="Horror", language="Hindi", category="Latest", quality="1080p Web-DL", video_url="https://www.youtube.com/embed/KVnheXyw8Wk", download_url="https://movierulz.cine/dl/stree2_hd.mp4"),
            ...
            MovieModel(title="Animal", description="A father-son bond pushed to the extreme.", rating=7.8, image="https://images.unsplash.com/photo-1446776811953-b23d57bd21aa", genre="Action", language="Hindi", category="Present", quality="1080p WebRip", video_url="https://www.youtube.com/embed/Dydmp0WAs9s", download_url="https://movierulz.cine/dl/animal_2023_1080p.mkv"),
            MovieModel(title="Vikram", description="A high-stakes mission for a retired agent.", rating=8.4, image="https://images.unsplash.com/photo-1536440136628-849c177e76a1", genre="Thriller", language="Hindi", category="Present", quality="1080p BluRay", video_url="https://www.youtube.com/embed/OKBMCL-umJI", download_url="https://movierulz.cine/dl/vikram_hd_hindi.mkv"),
            ...
            # CLASSIC / OLD MOVIES
            MovieModel(title="Baahubali: The Beginning", description="The epic journey of Shivudu.", rating=8.1, image="https://images.unsplash.com/photo-1594909122845-11baa439b7bf", genre="Epic", language="Hindi", category="Classic", quality="1080p BluRay", video_url="https://www.youtube.com/embed/sOEg_YZQsTI", download_url="https://movierulz.cine/dl/baahubali_hd.mkv"),
